...
Il più importante punteggio standardizzato è forse il celebre punto $z$, che viene ottenuto centrando un valore osservato $x$ rispetto alla media $\mu$ della popolazione di riferimento e riscalando il risultato per la deviazione standard $\sigma$ della medesima popolazione:
...
Supponiamo di conoscere, per ogni gruppo d'età, i parametri normativi, quindi di sapere quale siano la media $\mu$ e la deviazione standard $\sigma$ della popolazione di riferimento, che salviamo nei due oggetti `m` e `s`:
